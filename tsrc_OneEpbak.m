...
for ns=minns2:na
    for ipf=1:Pfttlslen
        failrate2{ns,ipf}=failnum2{ns,ipf}./fixnum2{ns,ipf};
        fixrate2{ns,ipf}=fixnum2{ns,ipf}./Nsamp;
        sucrate2{ns,ipf}=sucnum2{ns,ipf}./fixnum2{ns,ipf};
...
clear fixnum2; clear failnum2; clear sucnum2;
