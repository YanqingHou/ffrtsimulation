function batchsimu_falsealarm_ffrt_hours(alljob, hours)
% cluster1 = parcluster ;
...
switch hours
    ...
    case 800
        cluster1 = parcluster('Iridis4_1node_800h');
    otherwise
        cluster1 = parcluster;
end
for i=1:length(alljob)
    job = batch(cluster1,@runonce_ffrt_falsealarm,1,{alljob(i)},'Pool',15);
end
