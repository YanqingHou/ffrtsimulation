function slicenum=tsrc_newslicewrite(filename,pref,postf,num,epcs)
...
for i=epcs
    ...
    fprintf(fpw,'%12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f %12.5f\n',reseprt');
    delete(tempfile);
end    
